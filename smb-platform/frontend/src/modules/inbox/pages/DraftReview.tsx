        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div>
            <label style={labelStyle}>
              Tags{' '}
              <span style={{ fontWeight: 400, color: '#94a3b8' }}>(comma-separated)</span>
            </label>
...
export default function DraftReview() {
  ...
  const showContactModal = !isLoading && !!ctx && !ctx.contact && !modalDismissed
              ...
              {contact.tags && contact.tags.length > 0 && (
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 4, marginTop: 8 }}>
                  {contact.tags.map((t: string) => (
                    <span key={t} style={{ background: '#f1f5f9', color: '#475569', fontSize: 11, padding: '2px 8px', borderRadius: 10 }}>
                      {t}
                    </span>
                  ))}
                </div>
          ...
          <div style={{ borderTop: '1px solid #e2e8f0', paddingTop: 24 }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <button
                  ...
                  style={{
                    ...
                    fontSize: 13, fontWeight: 600, opacity: replyLoading ? 0.7 : 1,
                  }}
                >
                ...
                <button
                  ...
                  style={{
                    ...
                    opacity: (improveLoading || !replyText.trim()) ? 0.6 : 1,
                  }}
                >
            ...
            <textarea
              ...
              style={{
                ...
                boxSizing: 'border-box', minHeight: 120, fontFamily: 'inherit',
              }}
            />
