...
**[FLOW6] Flow chaining (flows trigger flows)** — ✅ **shipped 2026-07-09, no DDL, commit `0d67d07`**. See ✅ Done / Latest. Chain identity via ContextVar (zero service signature changes); chain_depth ≤ 3 + cycle path guard; opt in per flow. Items 4+5 (campaign button retire) deferred.
