...
- **[MKTG1] Marketing module** — `Opus` — *not built.* Dedicated sidebar module (replaces old TemplatesPage as the home for all campaign-related work). Houses GrapesJS template designer, campaign buttons, audience targeting, dispatch, and analytics in one place. **Depends on [GRAPES1] being merged.** Supersedes [CAM1].
