"""Bilingual email copy for all GetYippie transactional emails.
...
EMAILS: dict[str, dict[str, dict[str, str]]] = {
    ...
    "invite": {
        "en": {
            "subject": "Set your password for your {tenant_name} account on GetYippie",
            "greeting": "Hi {full_name},",
            "line1": "You've been invited to {tenant_name} on GetYippie.",
            "line2": "Set your password here (the link is valid for 7 days):",
            "footer": "Team GetYippie",
            "ignore": "If you weren't expecting this email, you can safely ignore it.",
        },
        "nl": {
            "subject": "Stel je wachtwoord in voor je {tenant_name}-account op GetYippie",
            "greeting": "Hoi {full_name},",
            "line1": "Je bent uitgenodigd voor {tenant_name} op GetYippie.",
    ...
    "demo_ready": {
        "en": {
            "subject": "Your GetYippie workspace is ready",
            "greeting": "Hi {first_name},",
            "line1": "Thank you for requesting a GetYippie demo. Really appreciate you taking the time.",
            ...
            "btn_label": "Open your GetYippie workspace",
            ...
            "signature": "Diederik",
            "title": "Founder, GetYippie",
        },
        "nl": {
            "subject": "Je GetYippie-werkruimte is klaar",
            "greeting": "Hoi {first_name},",
            "line1": "Bedankt dat je een GetYippie-demo hebt aangevraagd. Echt fijn dat je de tijd neemt.",
    ...
    "verification": {
        "en": {
            "subject": "Your GetYippie workspace is ready. First 30 days free",
            "greeting": "Hi {first_name},",
            "line1": "Your GetYippie workspace is ready. Click the link below to step right in:",
            ...
            "ignore": "If you didn't sign up for GetYippie, you can safely ignore this email.",
            "signature": "Diederik",
            "title": "Founder, GetYippie",
            # HTML fragments
            "html_intro": "Your GetYippie workspace is ready. One click and you're in. Your first 30 days are free, no payment details needed.",
            "btn_label": "Enter my workspace",
        },
        "nl": {
            "subject": "Je GetYippie-werkruimte is klaar. Eerste 30 dagen gratis",
            "greeting": "Hoi {first_name},",
            "line1": "Je GetYippie-werkruimte is klaar. Klik op de link hieronder om direct in te stappen:",
            ...
            "ignore": "Als je je niet hebt aangemeld bij GetYippie, kun je deze e-mail veilig negeren.",
            "signature": "Diederik",
            "title": "Oprichter, GetYippie",
            # HTML fragments
            "html_intro": "Je GetYippie-werkruimte is klaar. Eén klik en je bent binnen. De eerste 30 dagen zijn gratis, geen betaalgegevens nodig.",
    ...
    "welcome_inbox": {
        "en": {
            "subject": "Welcome to GetYippie 👋",
            "greeting": "Hi {tenant_name},",
            "intro": (
                "Welcome to GetYippie! This is your inbox. Every email your customers send to your\n"
                "support address lands here, and GetYippie drafts a ticket for each one automatically."
            ),
            "getting_started_header": "Getting started:",
            "getting_started": (
                "  - Inbox: review the tickets GetYippie drafts from incoming mail. Approve, edit or reject.\n"
        ...
        "nl": {
            "subject": "Welkom bij GetYippie 👋",
            "greeting": "Hoi {tenant_name},",
            "intro": (
                "Welkom bij GetYippie! Dit is je inbox. Elke e-mail die je klanten sturen naar je\n"
                "supportadres komt hier binnen, en GetYippie maakt er automatisch een ticket van."
            ),
            "getting_started_header": "Snel aan de slag:",
            "getting_started": (
                "  - Inbox: bekijk de tickets die GetYippie aanmaakt van binnenkomende e-mail. Goedkeuren, bewerken of afwijzen.\n"
