...
@scheduler.scheduled_job("interval", seconds=30, id="enrich_drafts", max_instances=1, coalesce=True)
...
@scheduler.scheduled_job("interval", seconds=30, id="flush_pending_sends", max_instances=1, coalesce=True)
