...
const ALL_MODULES = ['inbox', 'contacts', 'tickets', 'calendar', 'pipeline', 'booking', 'activity', 'billing', 'chat', 'ai', 'departments', 'marketing', 'tracking', 'sales']

const MODULE_LABELS: Record<string, string> = { pipeline: 'Kanban', ai: 'AI', booking: 'Booking', departments: 'Departments', marketing: 'Marketing', tracking: 'Tracking', sales: 'Sales' }
