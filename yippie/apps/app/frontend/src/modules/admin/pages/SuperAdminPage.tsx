...
const ALL_MODULES = ['inbox', 'contacts', 'tickets', 'calendar', 'pipeline', 'booking', 'activity', 'billing', 'chat', 'ai', 'departments']

const MODULE_LABELS: Record<string, string> = { ai: 'AI', booking: 'Booking', departments: 'Departments' }
