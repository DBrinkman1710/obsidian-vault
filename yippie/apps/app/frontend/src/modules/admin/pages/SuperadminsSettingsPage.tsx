...
const ALL_MODULES = ['inbox', 'contacts', 'tickets', 'activity', 'billing', 'chat', 'ai'] as const
type ModuleName = typeof ALL_MODULES[number]
const MODULE_LABELS: Record<ModuleName, string> = {
  inbox: 'Inbox', contacts: 'Contacts', tickets: 'Tickets',
  activity: 'Activity', billing: 'Billing', chat: 'Chat', ai: 'AI',
}
