...
const ALL_MODULES = ['inbox', 'contacts', 'tickets', 'calendar', 'activity', 'billing', 'chat', 'ai', 'emailtracking'] as const
type ModuleName = typeof ALL_MODULES[number]
const MODULE_LABELS: Record<ModuleName, string> = {
  inbox: 'Inbox', contacts: 'Contacts', tickets: 'Tickets', calendar: 'Calendar',
  activity: 'Activity', billing: 'Billing', chat: 'Chat', ai: 'AI', emailtracking: 'Email Tracking',
}
