...
// Matches every other page's demo CTA: routes to the app today, and can be
// repointed to /request-demo via NEXT_PUBLIC_DEMO_URL once that page ships.
          ...
          <div className={styles.quizResult}>
            {answered && recommendedPlan ? (
              <>
                ...
                <a href={DEMO_URL} className={styles.quizResultBtn}>
                  Request demo →
                </a>
              </>
            ) : (
