    ...
    <div className={styles.page}>
      ...
      <article className={styles.article}>
        ...
        <div className={styles.articleBody}>
          <p>
            Klantenservice software bestaat in twee extremen. Aan de ene kant: de gedeelde Gmail- of
          ...
          <p>
            ...
            Berichten komen binnen, worden gelezen, soms beantwoord, en soms volledig vergeten.
            Zo loopt het vast.
          </p>
          <p>
          ...
          <p>
            ...
            Niemand vroeg ernaar. Het vervolgmailtje van de klant (&quot;heeft u mijn bericht
            ontvangen?&quot;) is het eerste signaal dat er iets mis ging.
          </p>
          <p>
            ...
            twee verschillende systemen. Eén medewerker handelt de e-mail af, een ander pakt de
            WhatsApp op, en geen van beiden weet van de ander. De klant moet zichzelf tweemaal
          ...
          <p>
            ...
            ooit een prijspagina van een concurrent en probeerde te berekenen wat het zou kosten voor
            een team van tien met de functies die we nodig hadden, en gaf het op voor ik het antwoord
            vond. Dat is geen toeval.
          </p>
          ...
          <p>
            ...
            functierijk. Bedrijven die software bouwen voor het MKB beginnen óf vanuit een van deze
            twee kanten en voegen functies toe, óf ze bouwen iets zo generiek dat het geen van beide
            problemen goed oplost.
          </p>
          <p>
