    ...
    <div className={styles.page}>
      ...
      <article className={styles.article}>
        ...
        <div className={styles.articleBody}>
          ...
          <p>
            Een team deelt één emailadres voor klantvragen. Iedereen heeft het wachtwoord.
          ...
          <p>
            ...
            email én een WhatsApp bericht. In een gedeelde inbox zijn dat twee losse threads in
            twee verschillende systemen. Eén medewerker handelt de email af, een ander pakt
          ...
          <p>
            ...
            welk bericht in behandeling heeft. Ze willen een overzicht dat email en WhatsApp
          ...
          <p>
            ...
            medewerkers je toevoegt. Een inbox die email en WhatsApp samenvoegt zodat één
