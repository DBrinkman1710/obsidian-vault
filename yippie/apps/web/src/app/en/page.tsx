...
import UseCaseStories from "@/app/components/UseCaseStories";
import { PLAN_LIMITS } from "@/lib/config";
// import HourCounter from "@/app/components/HourCounter";
import {
  InboxIcon,
  TicketIcon,
  ChatIcon,
    ...
    <>
          ...
          <Reveal className={styles.heroCopy}>
            ...
            <div className={styles.heroActions}>
              <div className={styles.heroActionsTop}>
                <a href="/en/signup" className={styles.btnPrimary}>
      ...
      <section id="pricing" className={styles.section}>
        ...
        <div className={styles.founderBanner}>
          ...
          <a href="/en/signup?plan=founder" className={styles.founderBtn}>Claim a founder spot →</a>
        </div>

        <PricingTeaser />
        <div className={styles.pricingMore}>
          <a href="/en/pricing" className={styles.textLink}>
