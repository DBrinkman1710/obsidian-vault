...
export const metadata: Metadata = {
  title: "Request a demo | GetYippie",
  description:
    "See GetYippie in action. Get instant access to your own demo workspace and watch AI turn a messy support inbox into resolved tickets in seconds.",
  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <h1 className={styles.heroTitle}>See GetYippie on your own inbox</h1>
        <p className={styles.heroSub}>
          ...
          at how GetYippie saves your team hours every week.
        </p>
      </section>
