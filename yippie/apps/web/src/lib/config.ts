...
export const MODULE_LIST = [
  ...
  { id: "flows", label: "Flows", icon: "⚡", desc: "Automations that connect your modules: when something happens, GetYippie moves stages, notifies your team, or sends an email.", core: true, price: null, recName: null },
